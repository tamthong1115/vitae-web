        ...
        <div className="w-full h-full flex flex-row justify-center items-center gap-10">
            ...
            <div className="w-[40%] h-fit flex flex-col justify-start items-center gap-2">
                <Card className={'w-full'}>
                    <CardHeader>
                        <CardTitle className={'text-[var(--primary)]'}>{t("register")}</CardTitle>
                            ...
                            {({
                                ...
                                return (
                                    <form
                                        ...
                                        <span className={"bg-background inline-flex px-2"}>{t("account_name")}
                                        </span>
                                            </label>
                                            <Input
                                                id={'account_name'}
                                        ...
                                        <div className="w-full h-fit p-2 grid grid-cols-2 grid-rows-1 gap-2">
                                            ...
                                            <Link href={"/user/login"}
                                                  className={buttonVariants({variant: 'ghost'})}>{t("login")}</Link>
                                            <Button
                                                variant={'default'}
                                                type="submit"
