        ...
        <div className="w-full h-full flex flex-row justify-center items-center gap-10">
            ...
            <div className="w-[40%] h-fit flex flex-col justify-start items-center gap-2">
                <Card className={'w-full'}>
                    <CardHeader>
                        <CardTitle className={'text-[var(--primary)]'}>{t("login")}</CardTitle>
                    ...
                    <CardContent>
                                    ...
                                    <form
                                        ...
                                        <div className="w-full h-fit p-2 grid grid-cols-2 grid-rows-1 gap-2">
                                            <Link href={"/user/register"}
                                                  className={buttonVariants({variant: 'ghost'})}>{t("register")}</Link>
                                            <Button
                                                variant={'default'}
                                                type="submit"
                        ...
                        <div className={'w-full flex flex-row justify-center items-center gap-2 text-sm'}>
                    ...
                    <CardFooter className={'w-full flex flex-col justify-center items-center gap-2'}>
                        ...
                        <div
                            className="w-full h-fit m-2 p-2 shadow-lg rounded-lg grid md:grid-cols-1 md:grid-rows-2 lg:grid-cols-2 lg:grid-rows-1 gap-2">
                            <Link
                                href={'/'}
